          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="reunion_fechahora" value="<?php echo $this->input->post('reunion_fechahora'); ?>" class="has-datetimepicker form-control" id="reunion_fechahora" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="reunion_inicio" class="control-label">Reunion Inicio</label>
						<div class="form-group">
							<input type="text" name="reunion_inicio" value="<?php echo $this->input->post('reunion_inicio'); ?>" class="form-control" id="reunion_inicio" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="reunion_fin" class="control-label">Reunion Fin</label>
						<div class="form-group">
							<input type="text" name="reunion_fin" value="<?php echo $this->input->post('reunion_fin'); ?>" class="form-control" id="reunion_fin" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="reunion_tolerancia" class="control-label">Reunion Tolerancia</label>
						<div class="form-group">
							<input type="text" name="reunion_tolerancia" value="<?php echo $this->input->post('reunion_tolerancia'); ?>" class="form-control" id="reunion_tolerancia" />
						</div>
					</div>
				</div>
			</div>
