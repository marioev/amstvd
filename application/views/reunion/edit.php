    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Modificar Reuni&oacute;n</h3>
            </div>
                ...
                <div class="box-body">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <input type="time" step="any" name="reunion_inicio" value="<?php echo ($this->input->post('reunion_inicio') ? $this->input->post('reunion_inicio') : $reunion['reunion_inicio']); ?>" class="form-control" id="reunion_inicio" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label for="reunion_tolerancia" class="control-label">Tolerancia(Minutos)</label>
                            <div class="form-group">
                                <input type="number" name="reunion_tolerancia" value="<?php echo ($this->input->post('reunion_tolerancia') ? $this->input->post('reunion_tolerancia') : $reunion['reunion_tolerancia']); ?>" class="form-control" id="reunion_tolerancia" />
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label for="reunion_fin" class="control-label">Fin Reuni&oacute;n</label>
                            <div class="form-group">
                                <input type="time" step="any" name="reunion_fin" value="<?php echo ($this->input->post('reunion_fin') ? $this->input->post('reunion_fin') : $reunion['reunion_fin']); ?>" class="form-control" id="reunion_fin" />
                            </div>
                        </div>
                        <div class="col-md-3">
