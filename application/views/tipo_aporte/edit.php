    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Modificar Tipo Aporte</h3>
            </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" name="tipoaporte_nombre" value="<?php echo ($this->input->post('tipoaporte_nombre') ? $this->input->post('tipoaporte_nombre') : $tipo_aporte['tipoaporte_nombre']); ?>" class="form-control" id="tipoaporte_nombre" autocomplete="off" required onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
