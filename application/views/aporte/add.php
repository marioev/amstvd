          	...
          	<div class="box-body">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <input type="number" step="any" min="0" name="aporte_monto" value="<?php echo $this->input->post('aporte_monto'); ?>" class="form-control" id="aporte_monto" required />
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                <input type="text" maxlength="250" name="aporte_obs" value="<?php echo $this->input->post('aporte_obs'); ?>" class="form-control" id="aporte_obs" />
                            </div>
                        </div>
                    </div>
                </div>
