          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="aporte_nombre" value="<?php echo $this->input->post('aporte_nombre'); ?>" class="form-control" id="aporte_nombre" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="aporte_nombrepago" value="<?php echo $this->input->post('aporte_nombrepago'); ?>" class="form-control" id="aporte_nombrepago" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="aporte_mes" class="control-label">Aporte Mes</label>
						<div class="form-group">
							<input type="text" name="aporte_mes" value="<?php echo $this->input->post('aporte_mes'); ?>" class="form-control" id="aporte_mes" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="aporte_anio" class="control-label">Aporte Anio</label>
						<div class="form-group">
							<input type="text" name="aporte_anio" value="<?php echo $this->input->post('aporte_anio'); ?>" class="form-control" id="aporte_anio" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="aporte_monto" class="control-label">Aporte Monto</label>
						<div class="form-group">
							<input type="text" name="aporte_monto" value="<?php echo $this->input->post('aporte_monto'); ?>" class="form-control" id="aporte_monto" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="aporte_fechahora" class="control-label">Aporte Fechahora</label>
						<div class="form-group">
							<input type="text" name="aporte_fechahora" value="<?php echo $this->input->post('aporte_fechahora'); ?>" class="has-datetimepicker form-control" id="aporte_fechahora" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="aporte_obs" class="control-label">Aporte Obs</label>
						<div class="form-group">
							<input type="text" name="aporte_obs" value="<?php echo $this->input->post('aporte_obs'); ?>" class="form-control" id="aporte_obs" />
						</div>
					</div>
				</div>
			</div>
