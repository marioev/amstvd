<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('mesa_directiva/edit/'.$mesa_directiva['mesadir_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="asociado_id" class="form-control">
								...
								{
									$selected = ($asociado['asociado_id'] == $mesa_directiva['asociado_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="gestion_id" class="form-control">
								...
								{
									$selected = ($gestion['gestion_id'] == $mesa_directiva['gestion_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="organ_id" class="form-control">
								...
								{
									$selected = ($organizacion['organ_id'] == $mesa_directiva['organ_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="estado_id" class="form-control">
								...
								{
									$selected = ($estado['estado_id'] == $mesa_directiva['estado_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mesadir_nombreasoc" value="<?php echo ($this->input->post('mesadir_nombreasoc') ? $this->input->post('mesadir_nombreasoc') : $mesa_directiva['mesadir_nombreasoc']); ?>" class="form-control" id="mesadir_nombreasoc" />
						</div>
					</div>
				</div>
			</div>
