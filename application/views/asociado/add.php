            ...
            <?php echo form_open_multipart('asociado/add'); ?>
          	<div class="box-body">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-4">
                            <label for="asociado_ci" class="control-label">C.I.</label>
                            <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                <input type="file" name="asociado_foto" value="<?php echo $this->input->post('asociado_foto'); ?>" class="form-control btn-success" id="asociado_foto" />
                            </div>
                        </div>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <label for="asociado_login" class="control-label">Login (Acceso)</label>
                            <div class="form-group">
                                <input type="text" name="asociado_login" value="<?php echo $this->input->post('asociado_login'); ?>" class="form-control" id="asociado_login" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label for="asociado_clave" class="control-label">Contraseña</label>
                            <div class="form-group">
