      	...
      	<div class="box box-info">
            ...
            <div class="box-body">
                <div class="row clearfix">
                    <div class="col-md-6">
                        <label for="tipousuario_nombre" class="control-label"><span class="text-danger">*</span>Descripci&oacute;n</label>
                        <div class="form-group">
                            <input type="text" name="tipousuario_nombre" value="<?php echo $this->input->post('tipousuario_nombre'); ?>" class="form-control" id="tipousuario_nombre" required onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                        </div>
                    </div>
                    <div class="col-md-12">
