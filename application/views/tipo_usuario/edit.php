                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="tipousuario_nombre" value="<?php echo ($this->input->post('tipousuario_nombre') ? $this->input->post('tipousuario_nombre') : $tipo_usuario['tipousuario_nombre']); ?>" class="form-control" id="tipousuario_nombre" required onkeyup="var start = this.selectionStart; var end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);" />
                        </div>
                    </div>
                    <div class="col-md-6">
