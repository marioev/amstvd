    ...
    <table class="table">
                ...
                <table class="table" style="width: <?php echo $ancho;?>; padding: 0;" >
                    <tr>
                        ...
                        <td style="width: 6cm; padding: 0; line-height: 12px; " > 
                            <center><br>
                                <?php
                                /*if($pagado['pagado_id']==1){
                                    $titulo1 = "FACTURA"; $subtitulo = "ORIGINAL";
                                }else{
        ...
        <table class="table table-striped table-condensed"  style="width: <?php echo $ancho;?>;" >
            <tr  style="border-top-style: solid; border-bottom-style: solid; border-color: black;">
                ...
                <td align="center" style="padding: 0; background-color: #aaa !important; -webkit-print-color-adjust: exact;"><b>P.UNIT<br><?php echo $configuracion["moneda_nombre"]; ?></b></td>
                <td align="center" style="padding: 0; background-color: #aaa !important; -webkit-print-color-adjust: exact;"><b>TOTAL<br><?php echo $configuracion["moneda_nombre"]; ?></b></td>               
                <td align="center" style="padding: 0; background-color: #aaa !important; -webkit-print-color-adjust: exact;">
                    <b>TOTAL<br>
                    <?php
                    echo $configuracion["moneda_nombre"];
                    ?>
                    </b>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="padding: 0">
                    <font style="font-size:10px; font-family: arial;"> <?php echo $a['aporte_nombre'];?>
                </td>
