        ...
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-md-6 text-right" style="padding-right: 0px">
                    <a href="<?php echo site_url('estado/add'); ?>" class="btn btn-success btn-sm"><span class="fa fa-pencil-square-o"></span> Registrar Estado</a>
                </div>
            </div>

        </div> Registros Encontrados: <?php echo sizeof($estado); ?>
    </section>
</div>
<div class="input-group no-print"> <span class="input-group-addon">Buscar</span>
    <input id="filtrar" type="text" class="form-control" placeholder="Ingrese Estado">
</div>
<div class="row">
    <div class="col-md-12">
        <div class="box">
