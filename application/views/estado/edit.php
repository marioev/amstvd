				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estado_nombre" value="<?php echo ($this->input->post('estado_nombre') ? $this->input->post('estado_nombre') : $estado['estado_nombre']); ?>" class="form-control" id="estado_nombre" />
