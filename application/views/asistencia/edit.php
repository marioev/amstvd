    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Asistencia Edit</h3>
            </div>
			<?php echo form_open('asistencia/edit/'.$asistencia['asistencia_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="asociado_id" class="form-control">
								...
								{
									$selected = ($asociado['asociado_id'] == $asistencia['asociado_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="asistenca_nombre" value="<?php echo ($this->input->post('asistenca_nombre') ? $this->input->post('asistenca_nombre') : $asistencia['asistenca_nombre']); ?>" class="form-control" id="asistenca_nombre" />
